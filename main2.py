...
"""
            ...
            "pfr_nfl_draft_supp_data_RAW.csv"
            "pfr_nfl_draft_data_RAW.csv"

"""


def scrape_draft(selector, file):
    # for each year from 1970 to (and including) 2016
    for year in years:
        print("Scraping {} class".format(year))
        ...
        try:
            ...
            table_rows = soup.select(selector)[2:]
